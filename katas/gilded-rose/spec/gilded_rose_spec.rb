...
# NOTE uncomment one of the lines to run spec for proper GildedRose class
# rspec path/to/your/refactor
...
require File.join(File.dirname(__FILE__) + '/..', 'gilded_rose_refactored_3')
