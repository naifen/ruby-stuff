...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, rb = nil;

  Opal.add_stubs(['$===', '$base_price', '$*', '$private', '$+', '$new', '$puts', '$price']);
  
  (function($base, $super, $parent_nesting) {
    function $Jewelry(){};
    var self = $Jewelry = $klass($base, $super, 'Jewelry', $Jewelry);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Jewelry_initialize_1, TMP_Jewelry_price_2, TMP_Jewelry_base_price_3;

    def.grade = def.clarity = def.color = nil;
    
    
    Opal.defn(self, '$initialize', TMP_Jewelry_initialize_1 = function $$initialize(grade, clarity, color) {
      var self = this;
    ...
    }, TMP_Jewelry_initialize_1.$$arity = 3);
    
    Opal.defn(self, '$price', TMP_Jewelry_price_2 = function $$price() {
      var self = this, $case = nil;

      return (function() {$case = self.grade;
      if ("A+"['$===']($case)) {return self.$base_price()}
      else if ("A"['$===']($case)) {return $rb_times(0.9, self.$base_price())}
      else if ("B"['$===']($case)) {return $rb_times(0.8, self.$base_price())}
      else if ("C"['$===']($case)) {return $rb_times(0.7, self.$base_price())}
      else {return $rb_times(0.6, self.$base_price())}})()
    }, TMP_Jewelry_price_2.$$arity = 0);
    self.$private();
    return (Opal.defn(self, '$base_price', TMP_Jewelry_base_price_3 = function $$base_price() {
      var self = this;

      return $rb_plus(self.clarity, self.color)
    }, TMP_Jewelry_base_price_3.$$arity = 0), nil) && 'base_price';
  })($nesting[0], null, $nesting);
  (function($base, $super, $parent_nesting) {
    function $Ruby(){};
    var self = $Ruby = $klass($base, $super, 'Ruby', $Ruby);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Ruby_initialize_4;

    return (Opal.defn(self, '$initialize', TMP_Ruby_initialize_4 = function $$initialize(grade, clarity, color) {
      var self = this, $iter = TMP_Ruby_initialize_4.$$p, $yield = $iter || nil;

      if ($iter) TMP_Ruby_initialize_4.$$p = null;
      return $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_Ruby_initialize_4, false), [grade, clarity, color], null)
    }, TMP_Ruby_initialize_4.$$arity = 3), nil) && 'initialize'
  })($nesting[0], Opal.const_get_relative($nesting, 'Jewelry'), $nesting);
  rb = Opal.const_get_relative($nesting, 'Ruby').$new("A", 10, 10);
  return self.$puts(rb.$price());
})(Opal);
